...
@Slf4j
public class StompCommandWebSocketHandlerDecorator extends WebSocketHandlerDecorator {
...
//    }
    ...
    public StompCommandWebSocketHandlerDecorator(WebSocketHandler webSocketHandler) {
